...
require_once "admin/includes/photo_db.php";
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <!-- Preview Image -->
                <img class="img-responsive" src="https://via.placeholder.com/200" alt="">
                ...
                <div class="media">
                    <a class="pull-left" href="#">
                        <img class="media-object" src="https://via.placeholder.com/62" alt="">
                    </a>
